<script setup>
import AreaChart from "../components/Chart2.vue"
</script>

<template>
  <div class="layout5-container f-row f-center ftb">
        <div class="layout5-content f-col">
            <div class="layout5-caption f60 f-dark-blue">
                Supply Over Time
            </div>
